    ...
    <div class="col-md-6 col-lg-4">
      <div class="card">
        ...
        <div class="card-meta bg-primary p-3 text-light d-flex justify-content-between align-items-center">
          ...
          ?>
          <div>
            <p class="m-0 font-weight-bold">Fecha inicio: <span class="font-weight-normal"><?php echo $fecha; ?></span></p>
            <p class="m-0 font-weight-bold">Hora: <span class="font-weight-normal"><?php echo $hora; ?></span> </p>
          </div>
          <span class="badge badge-secondary px-2 py-2">$<?php echo $costo; ?></span>
        </div>
        <div class="card-body">
          ...
          <a href="<?php the_permalink(); ?>" class="btn btn-primary d-block d-md-inline" href="clase.html">Más
            Información.</a>
        </div>
      </div>
    </div>
